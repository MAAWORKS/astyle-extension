    ...
    public sealed class AsyncPackageRegistrationAttribute : RegistrationAttribute
    {
        ...
        public override void Register(RegistrationContext context)
        {
            ...
            try
            {
                ...
                {
                    this.RegisterUsing = context.RegistrationMethod;
                }

                // Select registration method
                switch (this.RegisterUsing)
                {
                ...
                if (!this.UseManagedResourcesOnly)
                {
                    try
                    {
                        ...
                        if (this.SatellitePath != null)
                        {
                            // Use provided path
                            satelliteDllPath = context.EscapePath(this.SatellitePath);
                        }
                        else
                        {
                ...
                if (this.AllowsBackgroundLoading)
                {
                ...
                {
                    packageKey.SetValue("SupportsDynamicToolOwner", PlatformUI.Boxes.BooleanTrue);
                }
            }
            finally
            {
